    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('store.report',$machine->id)}}" method="post" id="form_id" enctype="multipart/form-data">
                        ...
                        <div class="mt-2">
                            <input type="number" step="0.01" id="a" class="w-full bg-gray-200 form-control rounded" name="report[milage]" placeholder="Milage as read on dashboard" required />
                        </div>
                        <div class="flex">
                            <div class="inline-block mt-1 w-1/3 pr-1">
                            ...
                            <div class="inline-block mt-1 w-1/3 pr-1">
                                ...
                                <input class="form-control rounded bg-gray-600" name="report[type]" type="hidden" readonly value="{{$data->hours}}">
                            </div>
                        </div>
